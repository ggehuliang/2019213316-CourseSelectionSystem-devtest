...
void student_query_course()
{
	...
	do {
		...
		sprintf(pos, "6-6,2-25|7-7,2-27|8-8,2-32|9-9,2-35|10-10,2-27|12-12,2-25");
		handle = CreateThread(NULL, 0, ThreadFun, NULL, 0, NULL);
		scanf_opt(&option, 1, 6);
		TerminateThread(handle, 1);
...
void student_manage_info()
{
	...
	do {
		...
		sprintf(pos, "5-5,2-15|6-6,2-15|7-7,2-15|8-8,2-25|1--1,2-17|1--1,2-17");
		handle = CreateThread(NULL, 0, ThreadFun, NULL, 0, NULL);
...
void teacher_select_managemenu() 
{
	...
	do {
		...
		sprintf(pos, "5-5,2-31|6-6,2-37|7-7,2-35|8-8,2-37|9-9,2-41|11-11,2-25");
		handle = CreateThread(NULL, 0, ThreadFun, NULL, 0, NULL);
...
void teacher_findcourse()
{
	...
	sprintf(pos, "5-5,2-27|6-6,2-27|7-7,2-23|1--1,2-31|1--1,2-20|1--1,2-17");
	handle = CreateThread(NULL, 0, ThreadFun, NULL, 0, NULL);
...
void teacher_course_managemenu()
{
	...
	do {
		...
		sprintf(pos, "5-5,2-23|6-6,2-23|7-7,2-23|8-8,2-36|10-10,2-25|1--1,2-17");
		handle = CreateThread(NULL, 0, ThreadFun, NULL, 0, NULL);
...
void teacher_manage_info()
{
	...
	do {
		...
		printf("【  ③ - 返回上一个菜单 】\n\n");
		printf("\n请输入1，2，3或直接点击相应标题：");
		sprintf(pos, "5-5,2-15|6-6,2-15|7-7,2-25|1--1,2-17|1--1,2-17|1--1,2-17");
		handle = CreateThread(NULL, 0, ThreadFun, NULL, 0, NULL);
		scanf_opt(&option2, 1, 3);
		TerminateThread(handle, 1);
		switch (option2)
